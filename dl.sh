...
alias yd="youtube-dl -f '(webm[width <= 3840]) + (251/250/249/140/139)' -o '%(title)s - %(id)s - %(uploader)s - %(upload_date)s - %(resolution)s.%(ext)s' --all-subs --embed-subs --add-metadata -i"
